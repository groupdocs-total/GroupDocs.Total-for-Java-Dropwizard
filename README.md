...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-total/GroupDocs.Total-for-Java-Dropwizard/releases/download/0.4.46/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar total-0.4.46.jar configuration.yaml
## Open http://localhost:8080/ in your favorite browser.
```
